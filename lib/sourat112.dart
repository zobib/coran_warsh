...
class Sourat112 extends StatefulWidget {

  var nomSourat;
  Sourat112(this.nomSourat);

  @override
  _Sourat112State createState() => _Sourat112State();
}

class _Sourat112State extends State<Sourat112> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/112/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
