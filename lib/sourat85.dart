import 'package:coran_warch/sourat84.dart';
import 'package:coran_warch/sourat86.dart';
...
class Sourat85 extends StatefulWidget {

  var nomSourat;
  Sourat85(this.nomSourat);

  @override
  _Sourat85State createState() => _Sourat85State();
}

class _Sourat85State extends State<Sourat85> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/85/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/85/2.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
        ...
        child: new Row(
          ...
          children: <Widget>[
            TextButton(
              ...
              onPressed: () {
                widget.nomSourat = "الطارق";
                Navigator.of(context).pop();
                Navigator.push(context, MaterialPageRoute(builder: (context) => Sourat86(widget.nomSourat)));
              },
              child: Text('الطارق', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
            ),
            TextButton(
              style: ButtonStyle(
                foregroundColor: MaterialStateProperty.all<Color>(Colors.white),
              ...
              onPressed: () {
                widget.nomSourat = "الانشقاق";
                Navigator.of(context).pop();
                Navigator.push(context, MaterialPageRoute(builder: (context) => Sourat84(widget.nomSourat)));
              },
              child: Text('الانشقاق',style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
            )
          ],
        ),
      ),
