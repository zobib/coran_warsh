...
class Sourat92 extends StatefulWidget {

  var nomSourat;
  Sourat92(this.nomSourat);

  @override
  _Sourat92State createState() => _Sourat92State();
}

class _Sourat92State extends State<Sourat92> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/92/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/92/2.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
