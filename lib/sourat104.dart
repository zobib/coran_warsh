...
import 'package:coran_warch/sourat105.dart';
...
class Sourat104 extends StatefulWidget {

  var nomSourat;
  Sourat104(this.nomSourat);

  @override
  _Sourat104State createState() => _Sourat104State();
}

class _Sourat104State extends State<Sourat104> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/104/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/104/2.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
        ...
        child: new Row(
          ...
          children: <Widget>[
            TextButton(
              ...
              onPressed: () {
                widget.nomSourat = "الفيل";
                Navigator.of(context).pop();
                Navigator.push(context, MaterialPageRoute(builder: (context) => Sourat105(widget.nomSourat)));
              },
              child: Text('الفيل', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
            ),
            TextButton(
              style: ButtonStyle(
                foregroundColor: MaterialStateProperty.all<Color>(Colors.white),
