...
class Sourat106 extends StatefulWidget {

  var nomSourat;
  Sourat106(this.nomSourat);

  @override
  _Sourat106State createState() => _Sourat106State();
}

class _Sourat106State extends State<Sourat106> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/106/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
