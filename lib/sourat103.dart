...
class Sourat103 extends StatefulWidget {

  var nomSourat;
  Sourat103(this.nomSourat);

  @override
  _Sourat103State createState() => _Sourat103State();
}

class _Sourat103State extends State<Sourat103> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/103/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
