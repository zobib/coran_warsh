...
class Sourat97 extends StatefulWidget {

  var nomSourat;
  Sourat97(this.nomSourat);

  @override
  _Sourat97State createState() => _Sourat97State();
}

class _Sourat97State extends State<Sourat97> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/97/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/97/2.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/97/3.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
