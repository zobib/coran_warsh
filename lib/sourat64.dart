import 'package:coran_warch/sourat63.dart';
import 'package:coran_warch/sourat65.dart';
...
class Sourat64 extends StatefulWidget {

  var nomSourat;
  Sourat64(this.nomSourat);

  @override
  _Sourat64State createState() => _Sourat64State();
}

class _Sourat64State extends State<Sourat64> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/64/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/64/2.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/64/3.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/64/4.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/64/5.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
        ...
        child: new Row(
          ...
          children: <Widget>[
            TextButton(
              ...
              onPressed: () {
                widget.nomSourat = "الطلاق";
                Navigator.of(context).pop();
                Navigator.push(context, MaterialPageRoute(builder: (context) => Sourat65(widget.nomSourat)));
              },
              child: Text('الطلاق', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
            ),
            TextButton(
              style: ButtonStyle(
                foregroundColor: MaterialStateProperty.all<Color>(Colors.white),
              ...
              onPressed: () {
                widget.nomSourat = "المنافقون";
                Navigator.of(context).pop();
                Navigator.push(context, MaterialPageRoute(builder: (context) => Sourat63(widget.nomSourat)));
              },
              child: Text('المنافقون',style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
            )
          ],
        ),
      ),
