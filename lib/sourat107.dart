...
class Sourat107 extends StatefulWidget {

  var nomSourat;
  Sourat107(this.nomSourat);

  @override
  _Sourat107State createState() => _Sourat107State();
}

class _Sourat107State extends State<Sourat107> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/107/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/107/2.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
