...
class Sourat84 extends StatefulWidget {

  var nomSourat;
  Sourat84(this.nomSourat);

  @override
  _Sourat84State createState() => _Sourat84State();
}

class _Sourat84State extends State<Sourat84> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/84/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/84/2.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
