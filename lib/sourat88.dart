...
class Sourat88 extends StatefulWidget {

  var nomSourat;
  Sourat88(this.nomSourat);

  @override
  _Sourat88State createState() => _Sourat88State();
}

class _Sourat88State extends State<Sourat88> {
        ...
        body: ListView(
          ...
          children: <Widget>[
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/88/1.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/88/2.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              child: Card(
                child: Image(
                  image: AssetImage("https://raw.githubusercontent.com/adieng/coran_warsh/main/assets/images/sourats/88/3.webp"),
                  fit: BoxFit.cover,
                ),
              ),
            )
